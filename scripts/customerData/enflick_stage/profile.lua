...
baseOnInboundCallURL = "http://callrouter.stage.touch.com/callback/layered/onInboundCall";
baseOnAnswerURL = "http://callrouter.stage.touch.com/callback/layered/onAnswer";
basePrepaidTimerURL = "http://callrouter.stage.touch.com/callback/layered/onPrepaidTimer";
baseOnCallEndURL = "http://callrouter.stage.touch.com/callback/layered/onCallEnd";
baseOnConfAddURL = "http://callrouter.stage.touch.com/callback/layered/onConfAdd";
baseOnConfAnswerURL = "http://callrouter.stage.touch.com/callback/layered/onConfAnswer";
...
-- =========================================================
customerBaseDirectory = "/etc/freeswitch/scripts/customerData/enflick_stage/"
